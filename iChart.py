...
class ViewModeWidget(QWidget):
    def __init__(self, figure_manager):
        ...
        self.dot_color_check = QCheckBox('Red')
        self.x_color_check = QCheckBox('Green')
...
class AimModeWidget(QWidget):
    def __init__(self, figure_manager):
        ...
        # Apply a detailed stylesheet to control padding, margin, and spacing for each widget type
        self.setStyleSheet("""
             /* General settings for all widgets within this widget */
             QWidget {
                 padding: 0px;  /* Padding inside the widget */
             }

             /* Specific settings for radio buttons */
             QRadioButton {
                 margin-bottom: 10px;  /* Margin around radio buttons */
             }

             /* Settings for labels */
             QLabel {
                 margin: 0px;  /* Margin around labels */
                 padding: 0px; /* Padding inside labels */
             }

             /* Settings for push buttons */
             QPushButton {
                 margin-top: 10px;  /* Margin around buttons */
                 padding: 4px; /* Padding inside buttons */
             }
         """)
...
class TrendModeWidget(QWidget):
    def __init__(self, figure_manager):
        ...
        self.setStyleSheet("""
             ...
             /* Settings for date edits */
             QDateEdit {
                 margin: 0px;  /* Margin around date edits */
                 padding: 0px; /* Padding inside date edits */
             }
