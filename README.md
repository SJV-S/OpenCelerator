...
- ”I am getting a scary warning when installing.” This is normal and inevitable when running unregistered third-party apps. The only way around it is to buy a security certificate which will cost a lot of money. It is also uncessary when the project is open-source.
