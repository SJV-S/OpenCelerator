...
- Option 2: Add an [exclusion](https://support.microsoft.com/en-us/windows/add-an-exclusion-to-windows-security-811816c0-4dfd-af4a-47e4-c301afe13b26) to the folder where you will be running iChart. Click [here](https://youtu.be/1r93NtwZt4o) to see how to do it on Windows 10, or [here](https://youtu.be/j2XGZCLL-Is) for Windows 11. Option 2 is probably the better one.
