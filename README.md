...
The latest version 0.5.0 can be [downloaded here](https://github.com/SJV-S/OpenCelerator/releases/tag/0.5.0). Extract content in your preferred directory. Launch by running iChart executable.
