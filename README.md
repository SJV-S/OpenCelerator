...
When running the app the first time, right click and select "Run as administrator". Windows Defender will might raise a warning. To proceed, click on "More info" and then click "Run anyway".
